...
@:jsRequire("twilio/lib/rest/ipMessaging/v1/service/channel/member", "MemberInstance") extern class MemberInstance extends twilio.lib.interfaces.SerializableClass {
	/**
		Initialize the MemberContext
	**/
	function new(version:twilio.lib.rest.ipmessaging.V1, payload:MemberPayload, serviceSid:String, channelSid:String, sid:String);
