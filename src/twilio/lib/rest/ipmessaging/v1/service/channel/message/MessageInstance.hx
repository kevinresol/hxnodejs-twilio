...
@:jsRequire("twilio/lib/rest/ipMessaging/v1/service/channel/message", "MessageInstance") extern class MessageInstance extends twilio.lib.interfaces.SerializableClass {
	/**
		Initialize the MessageContext
	**/
	function new(version:twilio.lib.rest.ipmessaging.V1, payload:MessagePayload, serviceSid:String, channelSid:String, sid:String);
