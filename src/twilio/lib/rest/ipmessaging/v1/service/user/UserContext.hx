...
@:jsRequire("twilio/lib/rest/ipMessaging/v1/service/user", "UserContext") extern class UserContext {
	/**
	...
	**/
	...
	var userChannels : twilio.lib.rest.ipmessaging.v1.service.user.userchannel.UserChannelListInstance;
