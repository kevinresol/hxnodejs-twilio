...
@:jsRequire("twilio/lib/rest/ipMessaging/v1/service/user", "UserInstance") extern class UserInstance extends twilio.lib.interfaces.SerializableClass {
	/**
		Initialize the UserContext
	**/
	function new(version:twilio.lib.rest.ipmessaging.V1, payload:UserPayload, serviceSid:String, sid:String);
	...
	**/
	function userChannels():twilio.lib.rest.ipmessaging.v1.service.user.userchannel.UserChannelListInstance;
