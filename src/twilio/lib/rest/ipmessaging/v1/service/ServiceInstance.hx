...
@:jsRequire("twilio/lib/rest/ipMessaging/v1/service", "ServiceInstance") extern class ServiceInstance extends twilio.lib.interfaces.SerializableClass {
	/**
		Initialize the ServiceContext
	**/
	function new(version:twilio.lib.rest.ipmessaging.V1, payload:ServicePayload, sid:String);
	private var _proxy : ServiceContext;
	var accountSid : String;
	/**
		Access the channels
	**/
	function channels():twilio.lib.rest.ipmessaging.v1.service.channel.ChannelListInstance;
	...
	**/
	...
	/**
		Access the roles
	**/
	function roles():twilio.lib.rest.ipmessaging.v1.service.role.RoleListInstance;
	var sid : String;
	/**
	...
	**/
	...
	/**
		Access the users
	**/
	function users():twilio.lib.rest.ipmessaging.v1.service.user.UserListInstance;
