...
@:jsRequire("twilio/lib/rest/ipMessaging/v1/credential", "CredentialInstance") extern class CredentialInstance extends twilio.lib.interfaces.SerializableClass {
	/**
		Initialize the CredentialContext
	**/
	function new(version:twilio.lib.rest.ipmessaging.V1, payload:CredentialPayload, sid:String);
