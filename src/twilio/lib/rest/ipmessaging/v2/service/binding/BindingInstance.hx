...
@:jsRequire("twilio/lib/rest/ipMessaging/v2/service/binding", "BindingInstance") extern class BindingInstance extends twilio.lib.interfaces.SerializableClass {
	/**
		Initialize the BindingContext
	**/
	function new(version:twilio.lib.rest.ipmessaging.V2, payload:BindingPayload, serviceSid:String, sid:String);
