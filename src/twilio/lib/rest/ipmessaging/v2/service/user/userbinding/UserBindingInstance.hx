...
@:jsRequire("twilio/lib/rest/ipMessaging/v2/service/user/userBinding", "UserBindingInstance") extern class UserBindingInstance extends twilio.lib.interfaces.SerializableClass {
	/**
		Initialize the UserBindingContext
	**/
	function new(version:twilio.lib.rest.ipmessaging.V2, payload:UserBindingPayload, serviceSid:String, userSid:String, sid:String);
