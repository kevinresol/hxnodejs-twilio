...
@:jsRequire("twilio/lib/rest/ipMessaging/v2/service/channel/message", "MessageInstance") extern class MessageInstance extends twilio.lib.interfaces.SerializableClass {
	/**
		Initialize the MessageContext
	**/
	function new(version:twilio.lib.rest.ipmessaging.V2, payload:MessagePayload, serviceSid:String, channelSid:String, sid:String);
