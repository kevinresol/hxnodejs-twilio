...
@:jsRequire("twilio/lib/rest/ipMessaging/v2/service/channel", "ChannelInstance") extern class ChannelInstance extends twilio.lib.interfaces.SerializableClass {
	/**
		Initialize the ChannelContext
	**/
	function new(version:twilio.lib.rest.ipmessaging.V2, payload:ChannelPayload, serviceSid:String, sid:String);
	...
	**/
	...
	/**
		Access the invites
	**/
	function invites():twilio.lib.rest.ipmessaging.v2.service.channel.invite.InviteListInstance;
	var links : String;
	/**
		Access the members
	**/
	function members():twilio.lib.rest.ipmessaging.v2.service.channel.member.MemberListInstance;
	var membersCount : Float;
	/**
		Access the messages
	**/
	function messages():twilio.lib.rest.ipmessaging.v2.service.channel.message.MessageListInstance;
	...
	**/
	...
	/**
		Access the webhooks
	**/
	function webhooks():twilio.lib.rest.ipmessaging.v2.service.channel.webhook.WebhookListInstance;
