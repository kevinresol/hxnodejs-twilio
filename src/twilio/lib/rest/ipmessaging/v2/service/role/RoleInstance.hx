...
@:jsRequire("twilio/lib/rest/ipMessaging/v2/service/role", "RoleInstance") extern class RoleInstance extends twilio.lib.interfaces.SerializableClass {
	/**
		Initialize the RoleContext
	**/
	function new(version:twilio.lib.rest.ipmessaging.V2, payload:RolePayload, serviceSid:String, sid:String);
