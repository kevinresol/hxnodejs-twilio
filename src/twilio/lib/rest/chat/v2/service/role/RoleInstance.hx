...
@:jsRequire("twilio/lib/rest/chat/v2/service/role", "RoleInstance") extern class RoleInstance extends twilio.lib.interfaces.SerializableClass {
	/**
		Initialize the RoleContext
	**/
	function new(version:twilio.lib.rest.chat.V2, payload:RolePayload, serviceSid:String, sid:String);
