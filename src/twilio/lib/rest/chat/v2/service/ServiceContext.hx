...
@:jsRequire("twilio/lib/rest/chat/v2/service", "ServiceContext") extern class ServiceContext {
	/**
		Initialize the ServiceContext
	**/
	function new(version:twilio.lib.rest.chat.V2, sid:String);
	var bindings : twilio.lib.rest.chat.v2.service.binding.BindingListInstance;
	var channels : twilio.lib.rest.chat.v2.service.channel.ChannelListInstance;
	/**
	...
	**/
	...
	var roles : twilio.lib.rest.chat.v2.service.role.RoleListInstance;
	/**
	...
	**/
	...
	var users : twilio.lib.rest.chat.v2.service.user.UserListInstance;
