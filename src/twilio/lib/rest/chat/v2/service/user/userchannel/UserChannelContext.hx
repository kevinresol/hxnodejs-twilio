...
@:jsRequire("twilio/lib/rest/chat/v2/service/user/userChannel", "UserChannelContext") extern class UserChannelContext {
	/**
		Initialize the UserChannelContext
	**/
	function new(version:twilio.lib.rest.chat.V2, serviceSid:String, userSid:String, channelSid:String);
	/**
