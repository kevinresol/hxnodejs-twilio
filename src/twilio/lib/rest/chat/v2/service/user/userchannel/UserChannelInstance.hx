...
@:jsRequire("twilio/lib/rest/chat/v2/service/user/userChannel", "UserChannelInstance") extern class UserChannelInstance extends twilio.lib.interfaces.SerializableClass {
	/**
		Initialize the UserChannelContext
	**/
	function new(version:twilio.lib.rest.chat.V2, payload:UserChannelPayload, serviceSid:String, userSid:String, channelSid:String);
