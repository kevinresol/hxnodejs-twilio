...
@:jsRequire("twilio/lib/rest/chat/v2/service/user", "UserInstance") extern class UserInstance extends twilio.lib.interfaces.SerializableClass {
	/**
		Initialize the UserContext
	**/
	function new(version:twilio.lib.rest.chat.V2, payload:UserPayload, serviceSid:String, sid:String);
	...
	**/
	function userBindings():twilio.lib.rest.chat.v2.service.user.userbinding.UserBindingListInstance;
	/**
		Access the userChannels
	**/
	function userChannels():twilio.lib.rest.chat.v2.service.user.userchannel.UserChannelListInstance;
