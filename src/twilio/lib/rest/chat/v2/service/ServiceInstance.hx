...
@:jsRequire("twilio/lib/rest/chat/v2/service", "ServiceInstance") extern class ServiceInstance extends twilio.lib.interfaces.SerializableClass {
	/**
		Initialize the ServiceContext
	**/
	function new(version:twilio.lib.rest.chat.V2, payload:ServicePayload, sid:String);
	private var _proxy : ServiceContext;
	var accountSid : String;
	/**
		Access the bindings
	**/
	function bindings():twilio.lib.rest.chat.v2.service.binding.BindingListInstance;
	/**
		Access the channels
	**/
	function channels():twilio.lib.rest.chat.v2.service.channel.ChannelListInstance;
	...
	**/
	...
	/**
		Access the roles
	**/
	function roles():twilio.lib.rest.chat.v2.service.role.RoleListInstance;
	var sid : String;
	/**
	...
	**/
	...
	/**
		Access the users
	**/
	function users():twilio.lib.rest.chat.v2.service.user.UserListInstance;
