...
@:jsRequire("twilio/lib/rest/chat/v2/service/channel/member", "MemberInstance") extern class MemberInstance extends twilio.lib.interfaces.SerializableClass {
	/**
		Initialize the MemberContext
	**/
	function new(version:twilio.lib.rest.chat.V2, payload:MemberPayload, serviceSid:String, channelSid:String, sid:String);
