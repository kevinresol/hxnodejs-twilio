...
@:jsRequire("twilio/lib/rest/chat/v2/service/channel/invite", "InviteInstance") extern class InviteInstance extends twilio.lib.interfaces.SerializableClass {
	/**
		Initialize the InviteContext
	**/
	function new(version:twilio.lib.rest.chat.V2, payload:InvitePayload, serviceSid:String, channelSid:String, sid:String);
