...
@:jsRequire("twilio/lib/rest/chat/v2/service/channel/webhook", "WebhookInstance") extern class WebhookInstance extends twilio.lib.interfaces.SerializableClass {
	/**
		Initialize the WebhookContext
	**/
	function new(version:twilio.lib.rest.chat.V2, payload:WebhookPayload, serviceSid:String, channelSid:String, sid:String);
