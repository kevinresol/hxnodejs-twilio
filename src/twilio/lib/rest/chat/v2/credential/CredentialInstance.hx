...
@:jsRequire("twilio/lib/rest/chat/v2/credential", "CredentialInstance") extern class CredentialInstance extends twilio.lib.interfaces.SerializableClass {
	/**
		Initialize the CredentialContext
	**/
	function new(version:twilio.lib.rest.chat.V2, payload:CredentialPayload, sid:String);
