...
@:jsRequire("twilio/lib/rest/chat/v1/service", "ServiceContext") extern class ServiceContext {
	/**
		Initialize the ServiceContext
	**/
	function new(version:twilio.lib.rest.chat.V1, sid:String);
	var channels : twilio.lib.rest.chat.v1.service.channel.ChannelListInstance;
	/**
	...
	**/
	...
	var roles : twilio.lib.rest.chat.v1.service.role.RoleListInstance;
	/**
	...
	**/
	...
	var users : twilio.lib.rest.chat.v1.service.user.UserListInstance;
