...
@:jsRequire("twilio/lib/rest/chat/v1/service/channel", "ChannelContext") extern class ChannelContext {
	/**
	...
	**/
	...
	var invites : twilio.lib.rest.chat.v1.service.channel.invite.InviteListInstance;
	var members : twilio.lib.rest.chat.v1.service.channel.member.MemberListInstance;
	var messages : twilio.lib.rest.chat.v1.service.channel.message.MessageListInstance;
	/**
