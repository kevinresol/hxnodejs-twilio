...
@:jsRequire("twilio/lib/rest/pricing/v2/voice/country", "CountryInstance") extern class CountryInstance extends twilio.lib.interfaces.SerializableClass {
	/**
		Initialize the CountryContext
	**/
	function new(version:twilio.lib.rest.pricing.V2, payload:CountryPayload, isoCountry:String);
