...
@:jsRequire("twilio/lib/rest/taskrouter/v1/workspace/task/reservation", "ReservationInstance") extern class ReservationInstance extends twilio.lib.interfaces.SerializableClass {
	/**
		Initialize the ReservationContext
	**/
	function new(version:twilio.lib.rest.taskrouter.V1, payload:ReservationPayload, workspaceSid:String, taskSid:String, sid:String);
