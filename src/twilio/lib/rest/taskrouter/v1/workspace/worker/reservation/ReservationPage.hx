...
@:jsRequire("twilio/lib/rest/taskrouter/v1/workspace/worker/reservation", "ReservationPage") extern class ReservationPage extends twilio.lib.base.Page<twilio.lib.rest.taskrouter.V1, ReservationPayload, ReservationResource, ReservationInstance> {
	/**
