...
@:jsRequire("twilio/lib/rest/conversations/v1/role", "RoleInstance") extern class RoleInstance extends twilio.lib.interfaces.SerializableClass {
	/**
		Initialize the RoleContext
	**/
	function new(version:twilio.lib.rest.conversations.V1, payload:RolePayload, sid:String);
