...
@:jsRequire("twilio/lib/rest/conversations/v1/user", "UserInstance") extern class UserInstance extends twilio.lib.interfaces.SerializableClass {
	/**
		Initialize the UserContext
	**/
	function new(version:twilio.lib.rest.conversations.V1, payload:UserPayload, sid:String);
