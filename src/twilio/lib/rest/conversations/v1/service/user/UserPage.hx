...
@:jsRequire("twilio/lib/rest/conversations/v1/service/user", "UserPage") extern class UserPage extends twilio.lib.base.Page<twilio.lib.rest.conversations.V1, UserPayload, UserResource, UserInstance> {
	/**
