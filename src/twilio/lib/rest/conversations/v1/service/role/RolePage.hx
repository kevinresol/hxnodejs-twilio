...
@:jsRequire("twilio/lib/rest/conversations/v1/service/role", "RolePage") extern class RolePage extends twilio.lib.base.Page<twilio.lib.rest.conversations.V1, RolePayload, RoleResource, RoleInstance> {
	/**
