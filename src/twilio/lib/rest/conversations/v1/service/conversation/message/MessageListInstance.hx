...
typedef MessageListInstance = {
	...
	/**
		...
		create a MessageInstance
	**/
	@:overload(function(?opts:MessageListInstanceCreateOptions, ?callback:(error:Null<js.lib.Error>, item:MessageInstance) -> Dynamic):js.lib.Promise<MessageInstance> { })
	function create(?callback:(error:Null<js.lib.Error>, item:MessageInstance) -> Dynamic):js.lib.Promise<MessageInstance>;
	/**
