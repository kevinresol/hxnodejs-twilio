...
@:jsRequire("twilio/lib/rest/conversations/v1/service/conversation/webhook", "WebhookInstance") extern class WebhookInstance extends twilio.lib.interfaces.SerializableClass {
	/**
		Initialize the WebhookContext
	**/
	function new(version:twilio.lib.rest.conversations.V1, payload:WebhookPayload, chatServiceSid:String, conversationSid:String, sid:String);
