...
@:jsRequire("twilio/lib/rest/conversations/v1/service/conversation", "ConversationContext") extern class ConversationContext {
	/**
	...
	**/
	...
	var messages : twilio.lib.rest.conversations.v1.service.conversation.message.MessageListInstance;
	var participants : twilio.lib.rest.conversations.v1.service.conversation.participant.ParticipantListInstance;
	/**
	...
	**/
	...
	var webhooks : twilio.lib.rest.conversations.v1.service.conversation.webhook.WebhookListInstance;
