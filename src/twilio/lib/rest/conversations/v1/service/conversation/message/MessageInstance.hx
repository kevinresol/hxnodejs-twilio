...
@:jsRequire("twilio/lib/rest/conversations/v1/service/conversation/message", "MessageInstance") extern class MessageInstance extends twilio.lib.interfaces.SerializableClass {
	/**
		Initialize the MessageContext
	**/
	function new(version:twilio.lib.rest.conversations.V1, payload:MessagePayload, chatServiceSid:String, conversationSid:String, sid:String);
	...
	**/
	function deliveryReceipts():twilio.lib.rest.conversations.v1.service.conversation.message.deliveryreceipt.DeliveryReceiptListInstance;
	/**
