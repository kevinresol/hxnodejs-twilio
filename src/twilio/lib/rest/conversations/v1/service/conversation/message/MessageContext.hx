...
@:jsRequire("twilio/lib/rest/conversations/v1/service/conversation/message", "MessageContext") extern class MessageContext {
	/**
		Initialize the MessageContext
	**/
	function new(version:twilio.lib.rest.conversations.V1, chatServiceSid:String, conversationSid:String, sid:String);
	var deliveryReceipts : twilio.lib.rest.conversations.v1.service.conversation.message.deliveryreceipt.DeliveryReceiptListInstance;
	/**
