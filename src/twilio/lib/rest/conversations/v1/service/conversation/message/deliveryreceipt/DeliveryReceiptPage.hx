...
@:jsRequire("twilio/lib/rest/conversations/v1/service/conversation/message/deliveryReceipt", "DeliveryReceiptPage") extern class DeliveryReceiptPage extends twilio.lib.base.Page<twilio.lib.rest.conversations.V1, DeliveryReceiptPayload, DeliveryReceiptResource, DeliveryReceiptInstance> {
	/**
