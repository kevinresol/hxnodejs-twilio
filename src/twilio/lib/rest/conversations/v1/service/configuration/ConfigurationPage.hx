...
@:jsRequire("twilio/lib/rest/conversations/v1/service/configuration", "ConfigurationPage") extern class ConfigurationPage extends twilio.lib.base.Page<twilio.lib.rest.conversations.V1, ConfigurationPayload, ConfigurationResource, ConfigurationInstance> {
	/**
