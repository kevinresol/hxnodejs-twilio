...
@:jsRequire("twilio/lib/rest/conversations/v1/conversation", "ConversationInstance") extern class ConversationInstance extends twilio.lib.interfaces.SerializableClass {
	/**
		Initialize the ConversationContext
	**/
	function new(version:twilio.lib.rest.conversations.V1, payload:ConversationPayload, sid:String);
	...
	**/
	...
	/**
		Access the messages
	**/
	function messages():twilio.lib.rest.conversations.v1.conversation.message.MessageListInstance;
	var messagingServiceSid : String;
	/**
		Access the participants
	**/
	function participants():twilio.lib.rest.conversations.v1.conversation.participant.ParticipantListInstance;
	/**
	...
	**/
	...
	/**
		Access the webhooks
	**/
	function webhooks():twilio.lib.rest.conversations.v1.conversation.webhook.WebhookListInstance;
