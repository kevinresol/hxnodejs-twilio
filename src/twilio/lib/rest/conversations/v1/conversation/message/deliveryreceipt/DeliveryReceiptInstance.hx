...
@:jsRequire("twilio/lib/rest/conversations/v1/conversation/message/deliveryReceipt", "DeliveryReceiptInstance") extern class DeliveryReceiptInstance extends twilio.lib.interfaces.SerializableClass {
	/**
		Initialize the DeliveryReceiptContext
	**/
	function new(version:twilio.lib.rest.conversations.V1, payload:DeliveryReceiptPayload, conversationSid:String, messageSid:String, sid:String);
