...
@:jsRequire("twilio/lib/rest/notify/v1/credential", "CredentialInstance") extern class CredentialInstance extends twilio.lib.interfaces.SerializableClass {
	/**
	...
	**/
	function new(version:twilio.lib.rest.notify.V1, payload:CredentialPayload, sid:String);
