...
@:jsRequire("twilio/lib/rest/studio/v2/flow/execution/executionStep", "ExecutionStepInstance") extern class ExecutionStepInstance extends twilio.lib.interfaces.SerializableClass {
	/**
	...
	**/
	function new(version:twilio.lib.rest.studio.V2, payload:ExecutionStepPayload, flowSid:String, executionSid:String, sid:String);
	...
	**/
	function stepContext():twilio.lib.rest.studio.v2.flow.execution.executionstep.executionstepcontext.ExecutionStepContextListInstance;
	/**
