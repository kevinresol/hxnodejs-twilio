...
typedef ServiceListInstance = {
	...
	/**
		...
		create a ServiceInstance
	**/
	@:overload(function(?opts:ServiceListInstanceCreateOptions, ?callback:(error:Null<js.lib.Error>, item:ServiceInstance) -> Dynamic):js.lib.Promise<ServiceInstance> { })
	function create(?callback:(error:Null<js.lib.Error>, item:ServiceInstance) -> Dynamic):js.lib.Promise<ServiceInstance>;
	/**
