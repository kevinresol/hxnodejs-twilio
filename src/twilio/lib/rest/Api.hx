...
@:jsRequire("twilio/lib/rest/Api") extern class Api extends twilio.lib.base.Domain {
	/**
		Initialize api domain
	**/
	function new(twilio:twilio.Twilio);
	final account : twilio.lib.rest.api.v2010.account.AccountContext;
