...
@:jsRequire("twilio/lib/rest/wireless/v1/usageRecord", "UsageRecordPage") extern class UsageRecordPage extends twilio.lib.base.Page<twilio.lib.rest.wireless.V1, UsageRecordPayload, UsageRecordResource, UsageRecordInstance> {
	/**
