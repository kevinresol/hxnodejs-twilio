...
@:jsRequire("twilio/lib/rest/api/v2010/account/usage/record/yearly", "YearlyInstance") extern class YearlyInstance extends twilio.lib.interfaces.SerializableClass {
	/**
		Initialize the YearlyContext
	**/
	function new(version:twilio.lib.rest.api.V2010, payload:YearlyPayload, accountSid:String);
	...
	**/
	...
	static var prototype : YearlyInstance;
}