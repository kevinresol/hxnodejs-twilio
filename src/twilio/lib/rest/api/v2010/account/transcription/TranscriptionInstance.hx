...
@:jsRequire("twilio/lib/rest/api/v2010/account/transcription", "TranscriptionInstance") extern class TranscriptionInstance extends twilio.lib.interfaces.SerializableClass {
	/**
		Initialize the TranscriptionContext
	**/
	function new(version:twilio.lib.rest.api.V2010, payload:TranscriptionPayload, accountSid:String, sid:String);
