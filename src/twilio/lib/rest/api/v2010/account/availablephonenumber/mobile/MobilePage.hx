...
@:jsRequire("twilio/lib/rest/api/v2010/account/availablePhoneNumber/mobile", "MobilePage") extern class MobilePage extends twilio.lib.base.Page<twilio.lib.rest.api.V2010, MobilePayload, MobileResource, MobileInstance> {
	/**
