...
@:jsRequire("twilio/lib/rest/api/v2010/account/availablePhoneNumber/tollFree", "TollFreePage") extern class TollFreePage extends twilio.lib.base.Page<twilio.lib.rest.api.V2010, TollFreePayload, TollFreeResource, TollFreeInstance> {
	/**
