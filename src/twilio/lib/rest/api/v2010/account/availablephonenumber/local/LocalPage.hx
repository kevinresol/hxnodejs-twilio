...
@:jsRequire("twilio/lib/rest/api/v2010/account/availablePhoneNumber/local", "LocalPage") extern class LocalPage extends twilio.lib.base.Page<twilio.lib.rest.api.V2010, LocalPayload, LocalResource, LocalInstance> {
	/**
