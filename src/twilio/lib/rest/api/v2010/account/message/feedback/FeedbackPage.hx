...
@:jsRequire("twilio/lib/rest/api/v2010/account/message/feedback", "FeedbackPage") extern class FeedbackPage extends twilio.lib.base.Page<twilio.lib.rest.api.V2010, FeedbackPayload, FeedbackResource, FeedbackInstance> {
	/**
