...
@:jsRequire("twilio/lib/rest/api/v2010/account/queue", "QueueContext") extern class QueueContext {
	/**
	...
	**/
	...
	var members : twilio.lib.rest.api.v2010.account.queue.member.MemberListInstance;
	/**
	...
	**/
	...
	static var prototype : QueueContext;
}