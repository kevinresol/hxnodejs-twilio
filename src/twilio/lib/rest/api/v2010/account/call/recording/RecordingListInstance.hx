...
typedef RecordingListInstance = {
	...
	/**
		...
		create a RecordingInstance
	**/
	@:overload(function(?opts:RecordingListInstanceCreateOptions, ?callback:(error:Null<js.lib.Error>, item:RecordingInstance) -> Dynamic):js.lib.Promise<RecordingInstance> { })
	function create(?callback:(error:Null<js.lib.Error>, item:RecordingInstance) -> Dynamic):js.lib.Promise<RecordingInstance>;
	/**
