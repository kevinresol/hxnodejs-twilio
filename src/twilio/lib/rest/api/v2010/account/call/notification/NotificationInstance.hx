...
@:jsRequire("twilio/lib/rest/api/v2010/account/call/notification", "NotificationInstance") extern class NotificationInstance extends twilio.lib.interfaces.SerializableClass {
	/**
		Initialize the NotificationContext
	**/
	function new(version:twilio.lib.rest.api.V2010, payload:NotificationPayload, accountSid:String, callSid:String, sid:String);
