...
@:jsRequire("twilio/lib/rest/api/v2010/account/incomingPhoneNumber/local", "LocalInstance") extern class LocalInstance extends twilio.lib.interfaces.SerializableClass {
	/**
		Initialize the LocalContext
	**/
	function new(version:twilio.lib.rest.api.V2010, payload:LocalPayload, accountSid:String);
