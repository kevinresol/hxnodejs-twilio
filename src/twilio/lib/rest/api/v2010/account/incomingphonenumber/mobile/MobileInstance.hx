...
@:jsRequire("twilio/lib/rest/api/v2010/account/incomingPhoneNumber/mobile", "MobileInstance") extern class MobileInstance extends twilio.lib.interfaces.SerializableClass {
	/**
		Initialize the MobileContext
	**/
	function new(version:twilio.lib.rest.api.V2010, payload:MobilePayload, accountSid:String);
