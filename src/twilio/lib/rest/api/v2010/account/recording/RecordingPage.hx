...
@:jsRequire("twilio/lib/rest/api/v2010/account/recording", "RecordingPage") extern class RecordingPage extends twilio.lib.base.Page<twilio.lib.rest.api.V2010, RecordingPayload, RecordingResource, RecordingInstance> {
	/**
