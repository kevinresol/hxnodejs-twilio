...
@:jsRequire("twilio/lib/rest/api/v2010/account/recording/transcription", "TranscriptionPage") extern class TranscriptionPage extends twilio.lib.base.Page<twilio.lib.rest.api.V2010, TranscriptionPayload, TranscriptionResource, TranscriptionInstance> {
	/**
