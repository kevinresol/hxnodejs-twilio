...
@:jsRequire("twilio/lib/rest/messaging/v1/service/phoneNumber", "PhoneNumberInstance") extern class PhoneNumberInstance extends twilio.lib.interfaces.SerializableClass {
	/**
	...
	**/
	function new(version:twilio.lib.rest.messaging.V1, payload:PhoneNumberPayload, serviceSid:String, sid:String);
