...
typedef KeyListInstance = {
	...
	/**
		...
		create a KeyInstance
	**/
	@:overload(function(?opts:KeyListInstanceCreateOptions, ?callback:(error:Null<js.lib.Error>, item:KeyInstance) -> Dynamic):js.lib.Promise<KeyInstance> { })
	function create(?callback:(error:Null<js.lib.Error>, item:KeyInstance) -> Dynamic):js.lib.Promise<KeyInstance>;
	/**
