...
typedef FleetListInstance = {
	...
	/**
		...
		create a FleetInstance
	**/
	@:overload(function(?opts:FleetListInstanceCreateOptions, ?callback:(error:Null<js.lib.Error>, item:FleetInstance) -> Dynamic):js.lib.Promise<FleetInstance> { })
	function create(?callback:(error:Null<js.lib.Error>, item:FleetInstance) -> Dynamic):js.lib.Promise<FleetInstance>;
	/**
