...
@:jsRequire("twilio/lib/rest/preview/understand/assistant/task/sample", "SampleInstance") extern class SampleInstance extends twilio.lib.interfaces.SerializableClass {
	/**
	...
	**/
	function new(version:twilio.lib.rest.preview.Understand, payload:SamplePayload, assistantSid:String, taskSid:String, sid:String);
