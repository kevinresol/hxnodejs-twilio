...
@:jsRequire("twilio/lib/rest/preview/understand/assistant/task/field", "FieldInstance") extern class FieldInstance extends twilio.lib.interfaces.SerializableClass {
	/**
	...
	**/
	function new(version:twilio.lib.rest.preview.Understand, payload:FieldPayload, assistantSid:String, taskSid:String, sid:String);
