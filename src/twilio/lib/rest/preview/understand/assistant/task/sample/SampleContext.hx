...
@:jsRequire("twilio/lib/rest/preview/understand/assistant/task/sample", "SampleContext") extern class SampleContext {
	/**
	...
	**/
	function new(version:twilio.lib.rest.preview.Understand, assistantSid:String, taskSid:String, sid:String);
	/**
