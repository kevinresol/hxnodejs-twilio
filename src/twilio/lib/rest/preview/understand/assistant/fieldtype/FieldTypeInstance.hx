...
@:jsRequire("twilio/lib/rest/preview/understand/assistant/fieldType", "FieldTypeInstance") extern class FieldTypeInstance extends twilio.lib.interfaces.SerializableClass {
	/**
	...
	**/
	function new(version:twilio.lib.rest.preview.Understand, payload:FieldTypePayload, assistantSid:String, sid:String);
	...
	**/
	function fieldValues():twilio.lib.rest.preview.understand.assistant.fieldtype.fieldvalue.FieldValueListInstance;
