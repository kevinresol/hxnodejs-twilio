...
@:jsRequire("twilio/lib/rest/preview/understand/assistant/fieldType/fieldValue", "FieldValueInstance") extern class FieldValueInstance extends twilio.lib.interfaces.SerializableClass {
	/**
	...
	**/
	function new(version:twilio.lib.rest.preview.Understand, payload:FieldValuePayload, assistantSid:String, fieldTypeSid:String, sid:String);
