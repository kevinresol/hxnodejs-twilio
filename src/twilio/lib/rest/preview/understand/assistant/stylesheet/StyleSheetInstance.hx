...
@:jsRequire("twilio/lib/rest/preview/understand/assistant/styleSheet", "StyleSheetInstance") extern class StyleSheetInstance extends twilio.lib.interfaces.SerializableClass {
	/**
	...
	**/
	function new(version:twilio.lib.rest.preview.Understand, payload:StyleSheetPayload, assistantSid:String);
