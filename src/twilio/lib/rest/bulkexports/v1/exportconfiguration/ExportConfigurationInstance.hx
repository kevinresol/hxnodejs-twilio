...
@:jsRequire("twilio/lib/rest/bulkexports/v1/exportConfiguration", "ExportConfigurationInstance") extern class ExportConfigurationInstance extends twilio.lib.interfaces.SerializableClass {
	/**
	...
	**/
	function new(version:twilio.lib.rest.bulkexports.V1, payload:ExportConfigurationPayload, resourceType:String);
