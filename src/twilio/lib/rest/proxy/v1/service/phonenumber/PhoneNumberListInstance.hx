...
typedef PhoneNumberListInstance = {
	...
	/**
		...
		create a PhoneNumberInstance
	**/
	@:overload(function(?opts:PhoneNumberListInstanceCreateOptions, ?callback:(error:Null<js.lib.Error>, item:PhoneNumberInstance) -> Dynamic):js.lib.Promise<PhoneNumberInstance> { })
	function create(?callback:(error:Null<js.lib.Error>, item:PhoneNumberInstance) -> Dynamic):js.lib.Promise<PhoneNumberInstance>;
	/**
