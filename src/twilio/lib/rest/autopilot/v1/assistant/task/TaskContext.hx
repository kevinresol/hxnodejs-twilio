...
@:jsRequire("twilio/lib/rest/autopilot/v1/assistant/task", "TaskContext") extern class TaskContext {
	/**
	...
	**/
	...
	var fields : twilio.lib.rest.autopilot.v1.assistant.task.field.FieldListInstance;
	/**
		remove a TaskInstance
	**/
	function remove(?callback:(error:Null<js.lib.Error>, items:TaskInstance) -> Dynamic):js.lib.Promise<Bool>;
	var samples : twilio.lib.rest.autopilot.v1.assistant.task.sample.SampleListInstance;
	var statistics : twilio.lib.rest.autopilot.v1.assistant.task.taskstatistics.TaskStatisticsListInstance;
	var taskActions : twilio.lib.rest.autopilot.v1.assistant.task.taskactions.TaskActionsListInstance;
	/**
