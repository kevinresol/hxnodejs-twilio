...
@:jsRequire("twilio/lib/rest/autopilot/v1/assistant/task/taskActions", "TaskActionsInstance") extern class TaskActionsInstance extends twilio.lib.interfaces.SerializableClass {
	/**
	...
	**/
	function new(version:twilio.lib.rest.autopilot.V1, payload:TaskActionsPayload, assistantSid:String, taskSid:String);
