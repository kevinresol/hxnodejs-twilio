...
@:jsRequire("twilio/lib/rest/autopilot/v1/assistant/task/taskStatistics", "TaskStatisticsInstance") extern class TaskStatisticsInstance extends twilio.lib.interfaces.SerializableClass {
	/**
	...
	**/
	function new(version:twilio.lib.rest.autopilot.V1, payload:TaskStatisticsPayload, assistantSid:String, taskSid:String);
