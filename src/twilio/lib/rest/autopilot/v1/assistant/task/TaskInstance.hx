...
@:jsRequire("twilio/lib/rest/autopilot/v1/assistant/task", "TaskInstance") extern class TaskInstance extends twilio.lib.interfaces.SerializableClass {
	/**
	...
	**/
	function new(version:twilio.lib.rest.autopilot.V1, payload:TaskPayload, assistantSid:String, sid:String);
	...
	**/
	...
	/**
		Access the fields
	**/
	function fields():twilio.lib.rest.autopilot.v1.assistant.task.field.FieldListInstance;
	...
	**/
	...
	/**
		Access the samples
	**/
	function samples():twilio.lib.rest.autopilot.v1.assistant.task.sample.SampleListInstance;
	var sid : String;
	/**
		Access the statistics
	**/
	function statistics():twilio.lib.rest.autopilot.v1.assistant.task.taskstatistics.TaskStatisticsListInstance;
	/**
		Access the taskActions
	**/
	function taskActions():twilio.lib.rest.autopilot.v1.assistant.task.taskactions.TaskActionsListInstance;
	/**
