...
@:jsRequire("twilio/lib/rest/autopilot/v1/assistant/query", "QueryInstance") extern class QueryInstance extends twilio.lib.interfaces.SerializableClass {
	/**
	...
	**/
	function new(version:twilio.lib.rest.autopilot.V1, payload:QueryPayload, assistantSid:String, sid:String);
